...
%    a = fread (fid, 2*nblines, 'float'); % Read one ccm worth
    ...
    [thsrc_cat, phisrc_cat, thsrc_wsf, phisrc_wsf, suncomps, calvis, gainsol, sigmas, sigman, good] = pelican_sunAteamsub (acc, t_obs, freq, uvflag, flagant, debuglev, ptSun);
...
%             end
	  ...
	  save (fname, 't_obs', 'freq', 'diffimg', 'calmap', 'suncomps', 'phisrc_wsf', 'thsrc_wsf');
